...
namespace Ders1
{
    public partial class Form1 : Form
    {
        ...
        {
            List<Kisi> kisiListesi = dataGridView1.DataSource as List<Kisi>;
            KisileriRaporla kisileriRaporla = new KisileriRaporla(kisiListesi);
            kisileriRaporla.Show();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            List<vMaas> maasListesi = dataGridMaas.DataSource as List<vMaas>;
            MaasRaporla maasRaporla = new MaasRaporla(maasListesi);
            maasRaporla.Show();
        }
    }
}
